            ...
            <div class="footer">
                <div class="addresses">
                    ...
                    <div class="copyright-logo-links">
                        <div class="copyright">
                            <p>© "Хабаровский колледж отраслевых технологий и сферы обслуживания"
                        ...
                        <div class="links">
                            <ul>
                                <li><a target="_blank" href="https://vk.com/stimulcollege"><i class="fa-brands fa-vk"></i>ВКонтакте</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
